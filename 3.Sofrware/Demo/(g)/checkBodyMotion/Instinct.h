...
#define I2C_EEPROM
//这里可以想一下为什么角度数据保存的时候要用char类型定义，角度是个数字，为什么要转换成字符呢？
//这里是考虑省内存的原因，int整形是2个字节，byte类型虽然是一个字节但没有负值。
//而我们用到的角度数据范围不大，从-90到90。范围不大，
//而char类型刚好是-128到127.既满足范围，又占用更少内存。eeprom里面一次也只能存储一个字节
...
const char shualai2[] PROGMEM = { 
1, 0, 0,
  -30,-30,0,0,0,0,0,0,-90,-80,90,80,60,80,-60,-80,};

const char shualai3[] PROGMEM = { 
1, 0, 0,
  ...
  const char* skillNameWithType[]={"bdI","bkI","bkLI","bkRI","crI","crLI","crRI","lyI","trI","trLI","trRI","vtI","wkI","wkLI","wkRI","balanceI","buttUpI","calibI","cd1I","cd2I","droppedI","hiI","hi2I","liftedI","peeI","pee1I","pu1I","pu2I","rc1I","rc10I","rc2I","rc3I","rc4I","rc5I","rc6I","rc7I","rc8I","rc9I","restI","sitI","sleepI","strI","zeroI","shualai1I","shualai2I","shualai3I",};
  const char* progmemPointer[] = {bd, bk, bkL, bkR, cr, crL, crR, ly, tr, trL, trR, vt, wk, wkL, wkR, balance, buttUp, calib, cd1, cd2, dropped, hi, hi2, lifted, pee, pee1, pu1, pu2, rc1, rc10, rc2, rc3, rc4, rc5, rc6, rc7, rc8, rc9, rest, sit, sleep, str, zero,shualai1,shualai2,shualai3, };
