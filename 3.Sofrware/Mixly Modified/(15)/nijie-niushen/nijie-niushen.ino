...
void sc(){
  ...
  for(int i=0;i<=9;i++)
  {
    ...
    Serial.print(int(angle[i][0]),DEC);
    Serial.print(",");
    Serial.print(-int(angle[10+i][0]),DEC);
    Serial.print(",");
    Serial.print(-int(angle[10+i][0]),DEC);
    Serial.print(",");
    ...
    Serial.print(int(angle[i][1]),DEC);
    Serial.print(",");
    Serial.print(-int(angle[10+i][1]),DEC);
    Serial.print(",");
    Serial.print(-int(angle[10+i][1]),DEC);
    Serial.print(",");
    Serial.println();
  ...
  for(int i=10;i<=19;i++)
  {
    ...
    Serial.print(int(angle[i][0]),DEC);
    Serial.print(",");
    Serial.print(-int(angle[i-10][0]),DEC);
    Serial.print(",");
    Serial.print(-int(angle[i-10][0]),DEC);
    Serial.print(",");
    Serial.print(int(angle[i][1]),DEC);
    ...
    Serial.print(int(angle[i][1]),DEC);
    Serial.print(",");
    Serial.print(-int(angle[i-10][1]),DEC);
    Serial.print(",");
    Serial.print(-int(angle[i-10][1]),DEC);
    Serial.print(",");
    Serial.println();
  ...
  for(int i=10;i<=19;i++)
  {
    Serial.print(int(angle[i][0]),DEC);
    Serial.print(",");
    Serial.print(int(angle[i-i][0]),DEC);
    Serial.print(",");
    Serial.print(-int(angle[i-10][0]),DEC);
    Serial.print(",");
    Serial.print(-int(angle[10][0]),DEC);
    Serial.print(",");
    Serial.print(int(angle[i][1]),DEC);
    Serial.print(",");
    Serial.print(int(angle[i-i][1]),DEC);
    Serial.print(",");
    Serial.print(-int(angle[i-10][1]),DEC);
    Serial.print(",");
    Serial.print(-int(angle[10][1]),DEC);
    Serial.print(",");
    Serial.println();
