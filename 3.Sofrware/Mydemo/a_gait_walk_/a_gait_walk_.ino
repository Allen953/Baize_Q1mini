...
void loop() {
  // put your main code here, to run repeatedly:
   ...
   if(cmd=1)
   {
    pwm.setPWM(pins[0],0,S2P(-30+90-14));
    delay(500);
    pwm.setPWM(pins[0],0,S2P(0+90-14));
    delay(500);
    pwm.setPWM(pins[0],0,S2P(30+90-14));
    delay(500);
    pwm.setPWM(pins[0],0,S2P(0+90-14));
  ...
  for(int i=0;i<=44;i++)
  {
      pwm.setPWM(pins[8],0,S2P(bk[i][0]+90));
      Serial.print(int(bk[i][0]));
      Serial.print(',');
      Serial.println(bk[i][0]+90,DEC);
      pwm.setPWM(pins[9],0,S2P(90-bk[i][1]));
      pwm.setPWM(pins[10],0,S2P(90-bk[i][2]));
      pwm.setPWM(pins[11],0,S2P(bk[i][3]+90));
      pwm.setPWM(pins[12],0,S2P(90-bk[i][4]));
      pwm.setPWM(pins[13],0,S2P(bk[i][5]+90));
      pwm.setPWM(pins[14],0,S2P(bk[i][6]+90));
      pwm.setPWM(pins[15],0,S2P(90-bk[i][7]));
      delay(50);
  }
  //delay(50);*/
}
